...
class StatsControllerTest < ActionController::TestCase
  ...
  test "should create stat" do
    assert_difference('Stat.count') do
      post :create, stat: { kind: @stat.kind, popularity: @stat.popularity, service: @stat.service, value: @stat.value }
    end
  ...
  test "should update stat" do
    patch :update, id: @stat, stat: { kind: @stat.kind, popularity: @stat.popularity, service: @stat.service, value: @stat.value }
    assert_redirected_to stat_path(assigns(:stat))
  end
